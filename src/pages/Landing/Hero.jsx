    ...
    <div className='hero-bg h-[calc(95vh-70px)]'>
      <section className="Hero max-w-mw-normal mx-auto flex flex-col justify-center h-full px-8">
        <div className='text max-w-[800px]'>
          ...
          <p className='mt-8 text-neutral-200 text-lg font-medium text-center tablet:text-left font-inter-tight max-w-[600px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus libero voluptatum, sed inventore.</p>
