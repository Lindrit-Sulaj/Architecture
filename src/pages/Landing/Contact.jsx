  ...
  return (
    <div className='bg-blue-800 py-20 px-4 tablet:px-10'>
      <section className='mx-auto max-w-mw-normal flex flex-wrap tablet:flex-nowrap gap-6'>
        ...
        <form name='contact' data-netlify="true" method='POST' className='w-full tablet:w-[40%] flex flex-col gap-y-8 py-7 px-5 bg-blue-750 border-solid border-[1px] border-blue-700 rounded-xl laptop:px-8' netlify>
          <div className=''>
